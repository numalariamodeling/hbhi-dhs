...
medfev_pre_18 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd18)
head(medfev_pre_18)
...
medfev_pre_15 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd15)
head(medfev_pre_15)
...
medfev_pre_13 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd13)
head(medfev_pre_13)
...
medfev_pre_10 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd10)
head(medfev_pre_10)
...
medfev_pre_08 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd08)
head(medfev_pre_08)
...
medfev_pre_03 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd03)
head(medfev_pre_03)
...
medfev_pre_90 <- result.fun('med_fever', 'LGA','num_p', design=medfev.svyd90)
head(medfev_pre_90)
...
DS_file <- LGAshp_sf %>%  left_join(medfev_pre_18)
...
DS_file_15 <- LGAshp_sf %>% left_join(medfev_pre_15)
...
DS_file_13 <- LGAshp_sf %>% left_join(medfev_pre_13)
...
DS_file_10 <- LGAshp_sf %>% left_join(medfev_pre_10)
...
DS_file_08 <- LGAshp_sf %>% left_join(medfev_pre_08)
...
DS_file_03 <- LGAshp_sf %>% left_join(medfev_pre_03)
...
DS_file_90 <- LGAshp_sf %>% left_join(medfev_pre_90)
...
# 2018 map 
nga_medfev18 <- tmap.fun3(DS_file, "med_fever", "U5 prevalence",
              "Receipt of Medical Treatment for Fever in Nigerian LGAs (2018)",pts_file, 
              "Number of Participants", "med_fever")

# 2015 map 
nga_medfev15 <- tmap.fun3(DS_file_15, "med_fever", "U5 prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs(2015)",pts_file_15, 
                          "Number of Participants", "med_fever")

# 2013 map 
nga_medfev13 <- tmap.fun3(DS_file_13, "med_fever", "U5 prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (2013)",pts_file_13, 
                          "Number of Participants", "med_fever")


# 2010 map 
nga_medfev10 <- tmap.fun3(DS_file_10, "med_fever", "U5 prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (2010)",pts_file_10, 
                          "Number of Participants", "med_fever")

# 2008 map 
nga_medfev08 <- tmap.fun3(DS_file_08, "med_fever", "U5 prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (2008)",pts_file_08, 
                          "Number of Participants", "med_fever")

# 2003 map 
nga_medfev03 <- tmap.fun3(DS_file_03, "med_fever", "U5 prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (2003)",pts_file_03, 
                          "Number of Participants", "med_fever")

# 1990 map 
nga_medfev90 <- tmap.fun3(DS_file_90, "med_fever", "U5 prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (1990)",pts_file_90, 
                          "Number of Participants", "med_fever")

all_medfever_DS <- tmap_arrange(nga_medfev90,nga_medfev03,nga_medfev08,nga_medfev10,nga_medfev13,nga_medfev15,nga_medfev18)


tmap_save(tm = nga_medfev10, filename = "results/2010_U5 med_fever.pdf",

...
comboACT_pre_18_LGA <- result.fun('comboACT', 'State + v025','num_p', design=comboACT.svyd18)
...
write.csv(comboACT_18_LGA_repDS, "results/archetype_sim_input/Intervention_files_LGA/case_management/comboACT_18_LGA_repDS_v2.csv")
...
#generate LGA estimates 
comboACT_pre_15_LGA <- result.fun('comboACT', 'State +v025','num_p', design=comboACT.svyd15)
...
#generate LGA estimates 
comboACT_pre_13_LGA <- result.fun('comboACT', 'State + v025','num_p', design=comboACT.svyd13)
...
comboACT_pre_10 <- result.fun('comboACT', 'State + v025','num_p', design=comboACT.svyd10)
...
DS_file <- LGAshp_sf %>%left_join(comboACT_18_LGA_repDS)
...
# 
# 
# comboACT_18 <- tmap.fun4(DS_file, "U5 ACT use in Nigerian LGAs (2018)", "Prevalence", "comboACT")
# 
# comboACT_15 <- tmap.fun4(DS_file_15, "U5 ACT use in Nigerian LGAs (2015)", "Prevalence", "comboACT")
# 
# comboACT_13 <- tmap.fun4(DS_file_13, "U5 ACT use in Nigerian LGAs (2013)", "Prevalence", "comboACT")
# 
...
# 
# 
# all_comboACT_LGA <- tmap_arrange(comboACT_13,comboACT_15,comboACT_18)
# 
# tmap_save(tm = all_comboACT_LGA, filename = "results/archetype_sim_input/Intervention_files_LGA/case_management/comboACT_repDS_maps.pdf",

...
head(NGAshplist_sf$`./data/NG_2018_DHS_11072019_1720_86355/NGGE7AFL/NGGE7AFL.shp`)
...
LGAshp_sf <- st_as_sf(LGAshp) %>% mutate(LGA = ifelse(LGA == "kiyawa", "Kiyawa", ifelse(LGA == "kaita", "Kaita", 
                                                                      as.character(LGA))))

...
files<- files[-grep('_5000m_|Temp_covereates|DHS_18.csv|pop_density_|p_test_lagos_|pop_density_2000m_buffer_DHS_10_15_18.csv|pop_density_2km_buffer_DHS_10_15_18_30sec|building_density|elevation_', files)]
...
files<- files[-grep('_5000m_|pop_density_FB', files)]
...
write.csv(df, paste0(cleandatDir, '/all_cluster_variables_urban_malaria_all_buffers.csv'))

...
funEnv <- new.env()
sys.source(file = file.path(main_path, "src/DHS/1_variables_scripts/old", "Nigeria functions.R"), 
...
dhs18_sf <- st_read("data/NG_2018_DHS_11072019_1720_86355/NGGE7BFL/NGGE7BFL.shp")

mis15_sf <- st_read("data/NG_2015_MIS_06192019/NGGE71FL/NGGE71FL.shp")

mis10_sf <- st_read("data/NG_2010_MIS_06192019/NGGE61FL/NGGE61FL.shp")
...
clu_variales_10_18 <- read.csv("data/Nigereia_2010_2018_clustered_final_dataset.csv", header= TRUE)
colnames(clu_variales_10_18)
...
st_write(df_10_fin, "data/dataset1/cluster_attributes_dataset_1.shp")
st_write(df_18_fin, "data/dataset2/cluster_attributes_dataset_2.shp")

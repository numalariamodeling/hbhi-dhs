...
S_medpr_10 <- result.fun('med_fever', 'LGA','num_p', design=medf_pr.svyd10)
...
S_medpr_15 <- result.fun('med_fever', 'LGA','num_p', design=medf_pr.svyd15)
...
DS_file <- LGAshp_sf %>%  left_join(S_medpr_10)
...
DS_file_15 <- LGAshp_sf%>%left_join(S_medpr_15)
...
# 2010 map 
nga_medfev10 <- tmap.fun3(DS_file, "med_fever", "Adult prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (2010)",pts_file, 
                          "Number of Participants", "med_fever")


# 2015 map 
nga_medfev15 <- tmap.fun3(DS_file_15, "med_fever", "Adult prevalence",
                          "Receipt of Medical Treatment for Fever in Nigerian LGAs (2015)",pts_file_15, 
                          "Number of Participants", "med_fever")


all_medfever_AL <- tmap_arrange(nga_medfev10,nga_medfev15)

tmap_save(tm = all_medfever_AL, filename = "C:/Users/ido0493/Box/NU-malaria-team/projects/hbhi_nigeria/maps/DHS maps/Adult_med_fever/LGA/allmedfever_AL.pdf",

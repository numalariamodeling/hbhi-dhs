---
title: "Malaria-related variables in the Burkina Faso DHS/MIS"
output: 
  html_document:
    toc: true
    toc_float:
...
#### published version can be viewed at : http://rpubs.com/ifeomaozo/526400
```



# Setting up the survey datasets

```{r setup, include=FALSE, echo=FALSE}
require("knitr")
opts_knit$set(root.dir = "C:/Users/ido0493/Box/NU-malaria-team/data/burkina_dhs")
```
...
## Setting up the survey related variables and survey design object for U5 parasite prevalence estimation
...
ptest_month_10_map<- tmap_arrange(ptest_2010_jan_map, ptest_2010_apr_map, ptest_2010_may_map, ptest_2010_jun_map,
...
## Plotting the 2014 PR BF DHS PfPr by month of survey 
#Sep
...
## Cleaning up the datasets in preparation for mapping 
...
IRS_2010_map <- tm_shape(DS_IRS_10) + #this is the health district shapfile with test result info
  ...
  tm_layout(main.title="IRS Distribution by Health Districts (2010)",
            main.title.position = c("center", "top"))+
  tm_text("NOMDEP", size=0.5, root = 4)
...
IRS_2014_map <- tm_shape(DS_IRS_14) + #this is the health district shapfile with test result info
  tm_polygons(col = "IRS", textNA = "No data", 
              title = "Proportion of HH that received IRS", palette = "RdYlBu")+
  tm_layout(main.title="IRS Distribution by Health Districts (2014)",
            main.title.position = c("center", "top"))+
  tm_text("NOMDEP", size=0.5, root = 4)
```
